...
class ContentBrowserStringTest extends UnitSuite with TestEnvironment {
  ...
  val validContentBrowser = ContentBrowserString(contentString, "nb")

  val altValidContentBrowser =
    ContentBrowserString(LeftMarginContentBrowser, "nb")
  val alt2ValidContentBrowser = ContentBrowserString(RightContentBrowser, "nb")

  val invalidContentBrowser =
    ContentBrowserString(contentString.substring(1), "nb")
  ...
  test("That getStartEndIndex returns the correct start and end indexes") {
    ...
    ContentBrowserString("Innhold! " + contentString + "also junk", "nb").StartEndIndex should equal((9, 391))

    altValidContentBrowser.StartEndIndex should equal((0, 403))
    ContentBrowserString("junk junk" + LeftMarginContentBrowser + "also junk", "nb").StartEndIndex should equal(
      (9, 412))
  }
  ...
  test("That ContentBrowser is extracted correctly") {
    ...
    val contentBrowser = ContentBrowserString(stringWithContentBrowser, "nb")
